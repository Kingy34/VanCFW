...
APP_TITLE	:= VanCFW Installer
APP_DESCRIPTION	:= VanCFW installer v0.1
APP_AUTHOR	:= Kingy, with love to GhostLatte <3
#---------------------------------------------------------------------------------
...
all:
	...
	@echo
	@echo "You must install Image Magick (http://www.imagemagick.org/)."
